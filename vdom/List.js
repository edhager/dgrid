define([
	...
	var List = declare(null, {
		...
		postscript: function (params) {
			...
			this._throttledScrollHandler = miscUtil.throttleDelayed(this._scrollHandler, this);
		},
		listType: 'list',
		...
		buildRendering: function () {
			...
			// _throttledScrollHandler is set up in postscript and always runs in instance context
			bodyNodeProperties.onscroll = this._throttledScrollHandler;
		...
		_scrollHandler: function (event) {
			if (this.showHeader) {
				...
				this.headerNode.domNode.scrollLeft = event.scrollLeft || this.bodyNode.domNode.scrollLeft;
			}
			// re-fire, since browsers are not consistent about propagation here
			event.stopPropagation();
			listen.emit(this.node.domNode, 'scroll', { scrollTarget: this.bodyNode.domNode });
		},
